...
public class ClubAdapter extends RecyclerView.Adapter<ClubAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ClubAdapter.ViewHolder holder, int position) {
        ...
        holder.title.setText(String.valueOf(clubs.getAvailable_qty()) + " Disponibles");
        Glide.with(holder.itemView.getContext()).load("https://www.boxtomarket.com/img/logos_marcas_app/" + clubs.getImg_uri()).into(holder.img_uri);
    }
